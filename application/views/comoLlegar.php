...
<body class="fondo d-flex justify-content-center align-items-center" style="background-image: url('<?php echo base_url("assets/imagenes/fondo-como-llegar.jpg"); ?>');" data-bs-theme="dark">
    <div class="container bg-dark d-flex p-4 rounded justify-content-between">
